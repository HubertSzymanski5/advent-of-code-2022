...
import static pl.szymhu.day15.BeaconZone.BEACON;
import static pl.szymhu.day15.BeaconZone.SENSOR;

class BeaconZoneTest {
    ...
    void shouldPassAdventOfCodeExamplePartI() {
        ...
        BeaconZone beaconZone = BeaconZone.initialize(input);

        assertEquals(SENSOR, beaconZone.getMap().get(Point.of(2L, 18L)));
